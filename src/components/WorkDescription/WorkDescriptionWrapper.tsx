...
const WorkDescriptionWrapper = ({
  ...
  return (
    <div
      className={`opacity-0 bg-white/5 rounded-2xl h-fit col-span-full z-40 py-8 p-6 gap-12 grid grid-cols-1 relative top-1/4 md:mt-0 md:bg-black/80 md:gap-6 md:p-8 ${
