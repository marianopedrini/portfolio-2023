...
const Cursor = () => {
  ...
  return (
    <div
      className="opacity-0 fixed top-0 left-0 w-5 h-5 rounded-full pointer-events-none z-[200] mix-blend-difference p-2.5 flex justify-center items-center bg-white"
      id="custom-cursor"
      ref={cursorRef}
    >
      <p
